...
class Layout {
    ...
    /** The encoding to decode the stream */
    String encoding
     ...
     * @param encoding , encoding to decode the input Stream
     */
    @TypeChecked
    Layout(FORMAT inFormat, InputStream input, FORMAT outFormat, OutputStream output, URL xslfo, URL includePath, URL parser, String encoding) {
    ...
    /**
     * Creates a Layout object, assuming the right encoding
     * @param inFormat the input FORMAT
     * @param input the InputStream to read
     * @param outFormat the output FORMAT
     * @param output the {@link java.io.OutputStream OutputStream}
    ...
    Layout(FORMAT inFormat, InputStream input, FORMAT outFormat, OutputStream output, URL xslfo, URL includePath, URL parser) {
        this(inFormat, input, outFormat, output, xslfo, includePath, parser, DEFAULT_ENCODING)
    }
